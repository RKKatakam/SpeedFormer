...
class MLA(torch.nn.Module):
    def __init__(self, d_model, n_heads, max_len=1024, rope_theta=10000.0, causal=True):
        super().__init__()
        ...
        self.causal = causal  # Add causal parameter
    ...
    def forward(self, x, kv_cache=None, past_length=0):
        ...
        if self.causal:
            ...
            # For non-causal attention (encoder), allow all connections
            sq_mask = None
